...
{
    public class AbpSwaggerGenerator
    {
        ...
        /// <summary>
        /// Generate AbpSwaggerService for Abp WebApi
        /// </summary>
        ...
        /// <returns></returns>
        public AbpSwaggerService GenerateForAbpAppService(Type type, Type interfaceType, bool checkOpenWebApi = false,
            string excludedMethodName = "AbpSwagger")
        {
        ...
        private string GetHttpPath(AbpSwaggerOperation operation, MethodInfo method, List<ParameterInfo> parameters, ISchemaResolver schemaResolver)
        {
            string httpPath;
