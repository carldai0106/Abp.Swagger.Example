...
namespace Abp.Application
{
    public class SwaggerUiConfig
    {
        ...
        public SwaggerUiConfig(IEnumerable<string> discoveryPaths, Func<HttpRequestMessage, string> rootUrlResolver)
        {
            ...
            CustomAsset("index", thisAssembly, "Abp.SwaggerUi.CustomAssets.index.html");
            CustomAsset("css/screen-css", thisAssembly, "Abp.SwaggerUi.CustomAssets.screen.css");
            CustomAsset("css/typography-css", thisAssembly, "Abp.SwaggerUi.CustomAssets.typography.css");
            CustomAsset("lib/swagger-oauth-js", thisAssembly, "Abp.SwaggerUi.CustomAssets.swagger-oauth.js");
        }
