        ...
        public static void Run()
        {
            if (!_hasInited)
            {
                ...
                if (HostingEnvironment.IsHosted)
                {
                    ...
                    if (isRunningMono)
                    {
                        var httpModulesSection = WebConfigurationManager.GetWebApplicationSection("system.web/httpModules") as HttpModulesSection;
                        if (httpModulesSection != null)
                        {
                            var modules = httpModulesSection.Modules;
