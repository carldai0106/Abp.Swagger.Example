...
namespace MvcApp
{
    ...
    public class MvcWebAppModule : AbpModule
    {
        public override void Initialize()
        {
            ...
            SwaggerBuilder.ForAll<IApplicationService>(typeof(SwaggerApplicationModule).Assembly).Build();

            GlobalConfiguration.Configuration.EnableSwagger("WebApiDoc/{apiVersion}", SwaggerDocConfig)
